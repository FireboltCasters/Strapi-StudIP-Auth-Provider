...
const {StudipGrantConfig} = require('strapi-plugin-provider-studip');
...
module.exports = async () => {
  ...
  const myuosConfig = StudipGrantConfig.getGrantConfig(true, strapi, "myuos", null);
  console.log(myuosConfig);
